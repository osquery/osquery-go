...
func (p *ExtensionClient) Call(registry string, item string, request ExtensionPluginRequest) (r *ExtensionResponse, err error) {
	if err = p.sendCall(registry, item, request); err != nil {
		return
	}
	return p.recvCall()
}
...
func (p *ExtensionManagerClient) Extensions() (r InternalExtensionList, err error) {
	if err = p.sendExtensions(); err != nil {
		return
	}
...
func (p *ExtensionManagerClient) RegisterExtension(info *InternalExtensionInfo, registry ExtensionRegistry) (r *ExtensionStatus, err error) {
	if err = p.sendRegisterExtension(info, registry); err != nil {
		return
	}
...
func (p *ExtensionManagerClient) DeregisterExtension(uuid ExtensionRouteUUID) (r *ExtensionStatus, err error) {
	if err = p.sendDeregisterExtension(uuid); err != nil {
		return
	}
...
func (p *ExtensionManagerClient) Query(sql string) (r *ExtensionResponse, err error) {
	if err = p.sendQuery(sql); err != nil {
		return
	}
	return p.recvQuery()
}
...
func (p *ExtensionManagerClient) GetQueryColumns(sql string) (r *ExtensionResponse, err error) {
	if err = p.sendGetQueryColumns(sql); err != nil {
		return
	}
